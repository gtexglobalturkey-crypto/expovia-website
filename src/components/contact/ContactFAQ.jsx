...
const faqs = [
  {
    ...
    answer:
      "Simply contact the EREXPO team. We evaluate your products, target markets and objectives, then recommend the most suitable exhibitions and guide you through the complete participation process.",
  },
  {
    question: "Does EREXPO organize exhibitions?",
    answer:
      "EREXPO acts as an official international exhibition representative. We work closely with exhibition organizers and provide professional participation services for Turkish companies.",
  },
  {
  ...
  {
    question: "What services does EREXPO provide?",
    answer:
        ...
        <div className="contact-faq-layout">
          <div className="contact-faq-intro">
            ...
            <p>
              ...
              procedures and how EREXPO supports your company throughout the
              process.
            </p>
          </div>
