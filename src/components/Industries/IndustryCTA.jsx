...
function IndustryCTA() {
  ...
  const content = {
    en: {
      ...
      description:
        "Discover exhibitions aligned with your products, target markets and international growth goals. EREXPO supports your company throughout the participation process.",
    ...
    tr: {
      ...
      description:
        "Ürünlerinize, hedef pazarlarınıza ve uluslararası büyüme hedeflerinize uygun fuarları keşfedin. EREXPO, katılım sürecinin tamamında şirketinize destek olur.",
