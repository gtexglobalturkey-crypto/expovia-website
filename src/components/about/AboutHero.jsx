...
function AboutHero() {
  ...
  const content = {
    en: {
      ...
      description:
        "EREXPO was founded on more than 15 years of international exhibition experience. After years of working with organizers, manufacturers and exporters, we established EREXPO to provide a more professional, transparent and reliable exhibition representation service for Turkish companies expanding into global markets.",
      highlights: [
        {
          title: "15+ Years",
    ...
    tr: {
      label: "EREXPO Hakkında",
      titleFirst: "15 Yıllık Fuar Deneyimi.",
      titleSecond:
        "Yeni Nesil Uluslararası Fuar Hizmetleri.",
      description:
        "EREXPO, 15 yılı aşkın uluslararası fuar deneyimi üzerine kurulmuştur. Organizatörler, üreticiler ve ihracatçılarla yıllar boyunca edinilen deneyimin ardından, küresel pazarlara açılan Türk şirketlerine daha profesyonel, şeffaf ve güvenilir bir fuar temsilcilik hizmeti sunmak amacıyla EREXPO’yu kurduk.",
      highlights: [
        {
          title: "15+ Yıl",
